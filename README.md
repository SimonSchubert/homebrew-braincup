...
|------|-------------|---------|
| **Linux Command Library CLI** | Linux command reference CLI | `brew install simonschubert/tap/linux-command-library-cli` |
...
# Install CLI tools
brew install linux-command-library-cli
```
